...
| 21 — Proof | VII-D1 | 61 | **Unblocked 2026-09-06** — Wave 22 landed, so the tray D1's transcript walks is the one that ships. Hold it until Part VI's VI-D2 is merged: both need this machine's display and a real, billed harness run, and D2 is recording |
