...
**Needs nothing now — VI-D2 merged 2026-09-06.** It is the critical path: **VI-C10 and Part VII's VII-D1 both wait behind it.**
...
**Needs nothing.** Independent of every other Wave 17 card; touches no file any of them owns
except `shared.ts`, which **VI-C9 also edits — VI-C10 waits for VI-C9 to merge.**
